...
- Backend: Node + Express + TypeScript (Express runs on Node; Helmet for security headers)
...
build order at the end of the [design spec](docs/superpowers/specs/2026-07-10-true-alberta-roofing-website-design.md).

## Docs

- [Design spec](docs/superpowers/specs/2026-07-10-true-alberta-roofing-website-design.md) — what we're building and why
